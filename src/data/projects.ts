...
export const projects: Project[] = [
  ...
  },
  {
    ...
    subProjects: [
      { id: "sub-1", name: "projects.items.project-2.subProjects.0.name", description: "projects.items.project-2.subProjects.0.description", images: ["ssh.png"], features: ["projects.items.project-2.subProjects.0.features.0", "projects.items.project-2.subProjects.0.features.1"] },
  ...
  },
  {
    ...
    subProjects: [
      { id: "sub-victoria-1", name: "projects.items.project-7.subProjects.0.name", description: "projects.items.project-7.subProjects.0.description", images: ["rss.png"], features: ["projects.items.project-7.subProjects.0.features.0", "projects.items.project-7.subProjects.0.features.1"] },
      { id: "sub-victoria-2", name: "projects.items.project-7.subProjects.1.name", description: "projects.items.project-7.subProjects.1.description", images: ["issue_maker.png"], features: ["projects.items.project-7.subProjects.1.features.0", "projects.items.project-7.subProjects.1.features.1"] },
    ],
  },
  {
    id: "project-8",
  ...
  },
  {
    ...
    images: ["main.png", "BD_presentation.png", "BD.png", "texte.png", "tux_animation.webm"],
    logo: "tux.png",
    category: "Dev Web",
    purpose: "Éducation",
