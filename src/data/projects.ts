...
export const projects: Project[] = [
  ...
  },
  {
    ...
    images: ["backlog.webp", "affichage_challenge.webp", "breakthecode1.webp", "challenge.webp", "ssh.webp", "rainbow_jumper.gif", "cristal_malicieux.gif"],
    logo: "logo.webp",
    category: "Dev Web",
    purpose: "Éducation",
    features: [
  ...
  },
  {
    ...
    category: "IA",
    purpose: "Personnel",
    features: ["projects.items.project-13.features.0", "projects.items.project-13.features.1", "projects.items.project-13.features.2"],
    ...
    competencies: [
      {
        category: "Réaliser",
        level: "Niveau 3",
        items: ["projects.items.project-13.competencies.0.0"],
      },
      {
        category: "Optimiser",
        level: "Niveau 2",
