...
export const projects: Project[] = [
  {
    ...
    longDescription:
      "Ce projet est une application web complète qui démontre l'utilisation des technologies modernes comme Vue.js, TypeScript et Vite. L'application offre une expérience utilisateur fluide et performante.",
    ...
    competencies: [
      ...
      },
      {
        category: "Conduire",
        level: "Niveau 2",
        items: ["AC25.02 | Formaliser les besoins du client et de l'utilisateur"],
      },
      {
        category: "Gérer",
        level: "Niveau 2",
  ...
  },
  {
    ...
    longDescription:
      "Break The Code est une plateforme interactive pour les défis Capture The Flag (CTF) en cybersécurité, développée dans le cadre d'un projet associatif à l'IUT.",
    tags: ["Python", "Flask", "JavaScript", "HTML5", "CSS3", "Docker", "Scrum", "MySQL", "SSH"],
    images: [
      "affichage_challenge.png",
      "breakthecode1.png",
      "challenge.png",
      "ssh.png",
      "rainbow_jumper.gif",
  ...
  },
  {
    ...
    competencies: [
      ...
      },
      {
        category: "Gérer",
        level: "Niveau 2",
        items: ["AC24.01 | Optimiser les modèles de données de l’entreprise"],
      },
      {
        category: "Collaborer",
        level: "Niveau 2",
  ...
  },
  {
    ...
    competencies: [
      ...
      },
      {
        category: "Gérer",
        level: "Niveau 2",
        items: ["AC24.04 | Manipuler des données hétérogènes (Excel, CSV, API)"],
      },
      {
        category: "Conduire",
        level: "Niveau 1",
        items: ["AC15.01 | Appréhender les besoins du client et de l'utilisateur"],
      },
    ],
  },
  {
    ...
    longDescription:
      "Projet consistant à recréer le jeu de société japonais Trains en Java, avec une interface graphique JavaFX et une approche TDD.",
  ...
  },
  {
    ...
    longDescription:
      "Création d'une IA capable de classer les images par catégorie. Utilisation de PyTorch et des réseaux de convolution.",
    ...
    competencies: [
      {
        category: "Réaliser",
        level: "Niveau 2",
        items: ["AC21.03 | Adopter de bonnes pratiques de conception et de programmation"],
      },
      {
        category: "Optimiser",
        level: "Niveau 2",
  ...
  },
  {
    ...
    longDescription:
      "Victoria est une application de bureau utilisant une intelligence artificielle locale (Ollama), extensible via des plugins.",
  ...
  },
  {
    ...
    longDescription:
      "Application web pour apprendre 10 mots par jour via des quiz et des fiches de révision.",
    ...
    competencies: [
      {
        category: "Réaliser",
        level: "Niveau 3",
        items: ["AC31.01 | Choisir et implémenter les architectures adaptées (Mobile/PWA)"],
      },
      {
        category: "Administrer",
        level: "Niveau 2",
        items: ["AC23.01 | Concevoir et développer des applications communicantes (Firebase)"],
      },
      {
        category: "Gérer",
        level: "Niveau 1",
        items: ["AC14.01 | Mettre à jour et interroger une base de données relationnelle (MySQL)"],
      },
    ],
    subProjects: [
  ...
  },
  {
    ...
    category: "Dev Web",
    purpose: "Personnel",
    features: ["Notation et commentaires", "Classements communautaires"],
  ...
  },
  {
    ...
    name: "CHIRAL",
    description:
      "CHIRAL est un jeu vidéo a but educatif, qui présente le danger de la création de la vie miroir",
    longDescription:
      "CHIRAL est un jeu vidéo éducatif qui sensibilise les joueurs aux dangers de la création de la vie miroir. Le jeu met en scène une bactérie miroir qui se propage rapidement, mettant en danger l'équilibre écologique de la planète terre. Les joueurs doivent prendre des décisions stratégiques pour contenir la menace tout en apprenant les implications éthiques et scientifiques de la manipulation génétique.",
