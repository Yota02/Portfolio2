      ...
      <div class="hero-content">
        <div class="hero-text reveal-left">
          ...
          <div class="social-icons">
            ...
            <a href="mailto:amichauxkinet@gmail.com" class="social-icon" aria-label="Email">
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor">
...
const homeTitle = 'Alexis Michaux-Kinet | Portfolio Bioinformatique & IA'
const homeDescription = computed(() => t('home.description'))
